...
class _MainWindow(QtWidgets.QMainWindow, main_window_ui.Ui_MainWindow):
	...
	def open_fileFn(self, option):
		...
		if option == 0:
			fname = str(QtWidgets.QFileDialog.getOpenFileName(self, 'Select Image', '.', "Image Files(*.png *.jpg *.jpeg *.gif *.bmp)"))
			...
			fname = str(QtWidgets.QFileDialog.getOpenFileName(self, 'Encrypted File', '.', "Encrypto Encrypted Files(*.kmr)"))
			...
			fname = str(QtWidgets.QFileDialog.getOpenFileName(self, 'Select Image to Watermark', '.', "Image Files(*.png *.jpg *.jpeg *.gif *.bmp)"))
			...
			fname = str(QtWidgets.QFileDialog.getExistingDirectory(self, 'Select Encrypted File to Send', '.'))
			if fname:
